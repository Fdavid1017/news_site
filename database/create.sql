...
INSERT INTO user
	(email,first_name,second_name,password,role_id)
VALUES
	('admin@admin.hu', 'admin', 'name', '$2y$10$1WVXXv9j4YKPYkm2RrMAtuZVcx6nJ0W4nhVi64ji/N9tEUlE8OlTq', 1);
...
INSERT INTO
	post
	(user_email, text, category_id, add_date)
VALUES
	(
		'user@user.hu',
...
INSERT INTO
	comment
	(post_id, user_email, text, add_date)
VALUES
	(
		1,
		'user@user.hu',
